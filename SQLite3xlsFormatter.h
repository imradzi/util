...
=======
        using FunctionNonStaticMember = libxl::Sheet *(Generator::*)(ExcelReader *xlr, libxl::Sheet *sheet, std::shared_ptr<ReportPDF> rep, std::shared_ptr<wpSQLResultSet> rs, nlohmann::json &param, bool freezeHeader);
        using Function = libxl::Sheet *(*)(ExcelReader *xlr, libxl::Sheet *sheet, std::shared_ptr<ReportPDF> rep, std::shared_ptr<wpSQLResultSet> rs, nlohmann::json &param, bool freezeHeader);
>>>>>>> with_wxpdf
    public:
...
=======
        ...
        static std::string WriteToExcel(std::shared_ptr<wpSQLResultSet> rs, const std::string &title, const std::string &subTitle, const std::string &sheetName);
        static std::string WriteToExcel(std::vector<std::pair<std::shared_ptr<wpSQLResultSet>, std::vector<int>>> &rs, const std::string &title, const std::string &subTitle, const std::string &sheetName);
        static std::shared_ptr<ReportPDF> CreateNewPDF(std::shared_ptr<wpSQLResultSet> rs, const std::wstring &orientation, const std::wstring &sectionName, const std::wstring &title, const std::wstring &subTitle, nlohmann::json &param, const std::wstring outletName);
